...
describe("Payment Splitter Token Tests", function () {
	...
	describe("Functionality Tests", function () {
		...
		it("Should split ERC20 token", async function () {
			const { chessFishToken, paymentSplitter, erc20token, deployer, account0, account1 } = await loadFixture(deploy);
		...
		it("Should split ERC20 token 6 decimals", async function () {
			const { chessFishToken, paymentSplitter, erc20token6, deployer, account0, account1 } = await loadFixture(deploy);
